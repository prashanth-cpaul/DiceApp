...
class App extends Component {
  ...
  createShader = (gl, type) => {
    ...
    console.error(
      'ERROR compliling fragment shader!',
  ...
  componentDidMount() {
    ...
    var vertexShader = this.createShader(gl, gl.VERTEX_SHADER)
    var fragmentShader = this.createShader(gl, gl.FRAGMENT_SHADER)
    ...
    // Tell WebGL to take data from buffer and supply it to shader attributes
    ...
    var angle = 0
    var loop = function() {
      angle = (performance.now() / 1000 / 4) * 2 * Math.PI // One full rotation every 6 seconds
      glMatrix.mat4.rotate(xRotationMatrix, identityMatrix, angle, [0, 1, 0])
      glMatrix.mat4.rotate(yRotationMatrix, identityMatrix, angle / 2, [
        1,
        0,
        0
      ])
